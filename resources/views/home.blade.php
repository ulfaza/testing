...
@section('content')
    ...
    <div id="content">
            <div class="col-md-12">
                <div class="panel box-v4">
                    <div class="panel-heading bg-white border-none">
                        ...
                        <h4>Selamat Datang di Aplikasi Pengukuran Kualitas Perangkat Lunak ISO 25010</h4>
                        </br>
                        <p>Sebelum menggunakan aplikasi Ini, 
                        pastikan untuk membaca petunjuk langkah-langkah penggunaan aplikasi di bawah ini.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-12 padding-0">
                ...
                <div class="modal fade" id="modal_5" tabindex="0" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-scrollable" role="document">
                        <div class="modal-content">
                            <div class="modal-body">
